...
.otp-notice{
  ...
  font-family:var(--font-display);font-weight:600;font-size:.715rem;
  letter-spacing:-.01em;color:#F5A623;
  animation:otpPulse 2.4s ease-in-out infinite;
}
.otp-notice svg{width:12px;height:12px;flex-shrink:0}
@keyframes otpPulse{
...
.overlay-card{
  background:linear-gradient(155deg,rgba(255,255,255,.14),rgba(255,255,255,.03) 40%,rgba(255,255,255,.05) 100%),rgba(255,255,255,.06);
  border:1px solid rgba(255,255,255,.22);border-radius:16px;padding:30px 36px;
