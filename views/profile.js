...
<div class="pf-wrap" id="pfLoader" aria-hidden="true">
  <div class="pf-hero">
    <div class="sk-avatar-xl" style="width:88px;height:88px"></div>
    <div class="sk-line" style="width:46%;height:17px"></div>
    <div class="sk-line" style="width:30%;height:11px"></div>
  </div>

  <div class="pf-stats">
    <div class="pf-stat"><div class="sk-line" style="width:38px;height:16px"></div><div class="sk-line" style="width:56px;height:9px;margin-top:6px"></div></div>
    <div class="pf-stat"><div class="sk-line" style="width:38px;height:16px"></div><div class="sk-line" style="width:56px;height:9px;margin-top:6px"></div></div>
    <div class="pf-stat"><div class="sk-line" style="width:38px;height:16px"></div><div class="sk-line" style="width:56px;height:9px;margin-top:6px"></div></div>
  </div>

  <div class="acc-card" style="margin-top:18px">
    <div class="sk-line" style="width:24%;height:13px;margin-bottom:18px"></div>
    <div class="sk-stack">
      <div class="sk-row"><div class="sk-avatar"></div><div class="sk-row-body"><div class="sk-line w45"></div><div class="sk-line w30"></div></div></div>
...
async function loadPosts(username, isOwner){
  ...
  document.getElementById('postsList').innerHTML = '<div class="pf-post"><div class="sk-line w80"></div><div class="sk-line w45" style="margin-top:8px"></div><div class="sk-thumb" style="margin-top:10px"></div><div class="sk-inline" style="margin-top:10px"><div class="sk-chip" style="width:52px;height:22px"></div><div class="sk-chip" style="width:52px;height:22px"></div></div></div><div class="pf-post"><div class="sk-line w60"></div><div class="sk-line w80" style="margin-top:8px"></div><div class="sk-inline" style="margin-top:10px"><div class="sk-chip" style="width:52px;height:22px"></div><div class="sk-chip" style="width:52px;height:22px"></div></div></div>';
  try {
...
async function openFlist(type, username){
  ...
  document.getElementById('flistList').innerHTML = '<div class="sk-stack"><div class="sk-row"><div class="sk-avatar"></div><div class="sk-row-body"><div class="sk-line w60"></div><div class="sk-line w30"></div></div></div><div class="sk-row"><div class="sk-avatar"></div><div class="sk-row-body"><div class="sk-line w60"></div><div class="sk-line w30"></div></div></div><div class="sk-row"><div class="sk-avatar"></div><div class="sk-row-body"><div class="sk-line w60"></div><div class="sk-line w30"></div></div></div><div class="sk-row"><div class="sk-avatar"></div><div class="sk-row-body"><div class="sk-line w60"></div><div class="sk-line w30"></div></div></div></div>';
  overlay.classList.add('show');
  try {
