...
const FEATURES = [
  ...
  },
  {
    ...
    live: true,
    example: "GET /api/v1/dev/imagegen?prompt=a cat surfing a wave",
  },
  {
    key: "bgremove",
    title: "Background Remover",
    desc: "Remove the background from an image, returns a transparent PNG.",
    icon: '<path d="M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4z"/><path d="M17 14l3 3m0-3l-3 3"/>',
    category: "AI & Vision",
    endpoint: "POST /api/v1/dev/bg-remove",
    live: true,
    example: 'POST /api/v1/dev/bg-remove  { "image_url": "https://..." }',
  },
  {
    key: "summarize",
    title: "Text Summarizer",
    desc: "Condense a long piece of text into a short 2-4 sentence summary.",
    icon: '<path d="M4 6h16M4 12h16M4 18h10"/>',
    category: "AI & Vision",
    endpoint: "POST /api/v1/dev/summarize",
    live: true,
  ...
  },
  {
    ...
    desc: "Generate a random password with a chosen length and character set.",
    icon: '<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 018 0v4"/>',
    category: "Tools",
    endpoint: "GET /api/v1/dev/password?length=&symbols=",
    live: true,
    example: "GET /api/v1/dev/password?length=20&symbols=true",
  },
  {
    key: "hash",
    title: "Hash & Base64",
    desc: "Hash text (MD5/SHA1/SHA256/SHA512) or encode/decode base64.",
    icon: '<path d="M4 9h16M4 15h16M10 3L8 21M16 3l-2 18"/>',
    category: "Tools",
    endpoint: "POST /api/v1/dev/hash",
    live: true,
    example: 'POST /api/v1/dev/hash  { "text": "...", "mode": "hash", "algorithm": "sha256" }',
  },
  {
    key: "screenshot",
    title: "Website Screenshot",
    desc: "Capture a screenshot image of any public URL.",
    icon: '<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/>',
    category: "Tools",
    endpoint: "GET /api/v1/dev/screenshot?url=",
    live: true,
    example: "GET /api/v1/dev/screenshot?url=https://esteamstv.devs.surf",
  },
  {
    key: "translate",
    title: "Translator",
    desc: "Translate text between languages using ISO codes (e.g. en, es, fr, ja).",
    icon: '<circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15 15 0 010 20 15 15 0 010-20"/>',
    category: "Tools",
    endpoint: "GET /api/v1/dev/translate?text=&to=",
    live: true,
    example: "GET /api/v1/dev/translate?text=Hello&to=es",
  },
  {
    key: "wacheck",
    title: "WhatsApp Number Check",
    desc: "Check whether a phone number is registered on WhatsApp. Requires a connected bot on the platform to perform the lookup.",
    icon: '<path d="M3 21l1.65-4.95A9 9 0 1112 21a8.96 8.96 0 01-4.65-1.3L3 21z"/>',
    category: "Tools",
    endpoint: "GET /api/v1/dev/wa-check?number=",
    live: true,
    example: "GET /api/v1/dev/wa-check?number=2348012345678",
  },
  {
    key: "weather",
    title: "Weather",
  ...
  },
  {
    ...
    desc: "Pull a direct video file from a tweet link.",
    icon: '<path d="M22 4.01c-.88.6-2.02 1.03-3.14 1.15A4.5 4.5 0 0020.9 2.7a9 9 0 01-2.85 1.09A4.48 4.48 0 0011 6.5c0 .35.04.7.11 1.03C7.69 7.36 4.7 5.6 2.7 3.03a4.48 4.48 0 001.39 6c-.72-.02-1.4-.22-2-.55v.06a4.5 4.5 0 003.6 4.4 4.5 4.5 0 01-2 .08 4.5 4.5 0 004.2 3.13A9 9 0 012 18.4a12.7 12.7 0 006.9 2c8.3 0 12.8-6.9 12.8-12.8v-.58A9.2 9.2 0 0022 4.01z"/>',
    category: "Downloaders",
    endpoint: "GET /api/v1/dev/twitter?url=",
    live: true,
    example: "GET /api/v1/dev/twitter?url=https://x.com/user/status/...",
  },
  {
    key: "tiktokstalk",
    title: "TikTok Profile Lookup",
    desc: "Get a public TikTok user's bio, avatar, and stats.",
    icon: '<circle cx="12" cy="8" r="4"/><path d="M4 21v-1a8 8 0 0116 0v1"/>',
    category: "Lookup",
    endpoint: "GET /api/v1/dev/tiktokstalk?username=",
    live: true,
    example: "GET /api/v1/dev/tiktokstalk?username=someuser",
  },
  {
    key: "igstalk",
    title: "Instagram Profile Lookup",
    desc: "Get a public Instagram account's name, bio, and avatar.",
    icon: '<circle cx="12" cy="8" r="4"/><path d="M4 21v-1a8 8 0 0116 0v1"/>',
    category: "Lookup",
    endpoint: "GET /api/v1/dev/igstalk?username=",
    live: true,
    example: "GET /api/v1/dev/igstalk?username=someuser",
  },
  {
    key: "apk",
    title: "APK Search",
    desc: "Find an Android app's name, icon, and info page by name.",
    icon: '<rect x="6" y="2" width="12" height="20" rx="2"/><path d="M9 6h6"/>',
    category: "Lookup",
    endpoint: "GET /api/v1/dev/apk?query=",
    live: true,
    example: "GET /api/v1/dev/apk?query=whatsapp",
  },
  {
    key: "gdrive",
    title: "Google Drive Info",
    desc: "Get a shared Google Drive file's name, size, type, and direct link.",
    icon: '<path d="M7.5 3h9l6 10.5-4.5 8h-12l-4.5-8z"/>',
    category: "Tools",
    endpoint: "GET /api/v1/dev/gdrive?url=",
    live: true,
    example: "GET /api/v1/dev/gdrive?url=https://drive.google.com/file/d/.../view",
  },
  {
    key: "downloadweb",
    title: "Link Resolver",
    desc: "Follow redirects on any link and get its final URL, type, and size.",
    icon: '<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15 15 0 010 20 15 15 0 010-20z"/>',
    category: "Tools",
    endpoint: "GET /api/v1/dev/downloadweb?url=",
    live: true,
    example: "GET /api/v1/dev/downloadweb?url=https://example.com/file.zip",
  },
  {
    key: "book",
    title: "Book Page Image",
    desc: "Render text onto a styled book-page image.",
    icon: '<path d="M4 4h7v16H4z"/><path d="M13 4h7v16h-7z"/>',
    category: "Tools",
    endpoint: "GET /api/v1/dev/book?text=",
    live: true,
    example: "GET /api/v1/dev/book?text=Once upon a time...",
  },
  {
    key: "fakewa",
    title: "Fake WhatsApp Card",
    desc: "Generate a WhatsApp-style contact card image.",
    icon: '<path d="M21 11.5a8.5 8.5 0 01-12.9 7.3L3 20l1.3-5A8.5 8.5 0 1121 11.5z"/>',
    category: "Tools",
    endpoint: "GET /api/v1/dev/fakewa?name=&number=&status=",
    live: true,
    example: "GET /api/v1/dev/fakewa?name=John&number=234801234567&status=Busy",
  },
  {
    key: "caption",
    title: "Caption Meme",
    desc: "Overlay a bold caption bar onto any image.",
    icon: '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 15h18"/>',
    category: "Tools",
    endpoint: "GET /api/v1/dev/caption?image=&text=",
    live: true,
    example: "GET /api/v1/dev/caption?image=https://example.com/pic.jpg&text=hello",
  },
];
...
<div class="wrap">
  ...
  --output image.jpg</pre>
    ...
    <h2 class="doc-h2">Background Remover</h2>
    <p class="doc-p"><span class="badge badge-post">POST</span> <code>/api/v1/dev/bg-remove</code></p>
    <p class="doc-p">Give it a direct image URL, get back a link to the same image with the background removed (transparent PNG).</p>
    <pre>curl -X POST -H "x-api-key: estv_your_key_here" -H "Content-Type: application/json" \\
  -d '{"image_url":"https://example.com/photo.jpg"}' \\
  "https://esteamstv.devs.surf/api/v1/dev/bg-remove"</pre>
    <pre>{
  "image_url": "https://v3b.fal.media/files/xxxxx.png"
}</pre>

    <h2 class="doc-h2">Text Summarizer</h2>
    <p class="doc-p"><span class="badge badge-post">POST</span> <code>/api/v1/dev/summarize</code></p>
    <p class="doc-p">Send a block of text (6000 character limit), get back a short 2-4 sentence summary.</p>
    <pre>curl -X POST -H "x-api-key: estv_your_key_here" -H "Content-Type: application/json" \\
  -d '{"text":"..."}' \\
  "https://esteamstv.devs.surf/api/v1/dev/summarize"</pre>
    <pre>{
  ...
  "date": "2026-08-05"
    ...
    <h2 class="doc-h2">Password Generator</h2>
    <p class="doc-p"><span class="badge badge-get">GET</span> <code>/api/v1/dev/password?length=&amp;symbols=</code></p>
    <p class="doc-p">Optional <code>length</code> (4-128, default 16), and <code>upper</code>/<code>lower</code>/<code>numbers</code>/<code>symbols</code> as <code>true</code>/<code>false</code> to toggle character sets.</p>
    <pre>curl -H "x-api-key: estv_your_key_here" \\
  "https://esteamstv.devs.surf/api/v1/dev/password?length=20&symbols=true"</pre>
    <pre>{
  "password": "aB3!kZ9mQ2pL7vN0xR1w",
  "length": 20
}</pre>

    <h2 class="doc-h2">Hash and Base64</h2>
    <p class="doc-p"><span class="badge badge-post">POST</span> <code>/api/v1/dev/hash</code></p>
    <p class="doc-p"><code>mode</code> is one of <code>hash</code> (default), <code>base64encode</code>, or <code>base64decode</code>. For <code>hash</code>, <code>algorithm</code> is one of <code>md5</code>, <code>sha1</code>, <code>sha256</code> (default), <code>sha512</code>.</p>
    <pre>curl -X POST -H "x-api-key: estv_your_key_here" -H "Content-Type: application/json" \\
  -d '{"text":"hello world","mode":"hash","algorithm":"sha256"}' \\
  "https://esteamstv.devs.surf/api/v1/dev/hash"</pre>
    <pre>{
  "input": "hello world",
  "algorithm": "sha256",
  "result": "b94d27b9934d3e08a52e52d7da7dabfac484efe37a5380ee9088f7ace2efcde"
}</pre>

    <h2 class="doc-h2">Website Screenshot</h2>
    <p class="doc-p"><span class="badge badge-get">GET</span> <code>/api/v1/dev/screenshot?url=</code></p>
    <p class="doc-p">Returns a PNG image directly, not JSON. <code>url</code> must be a public http(s) link.</p>
    <pre>curl -H "x-api-key: estv_your_key_here" \\
  "https://esteamstv.devs.surf/api/v1/dev/screenshot?url=https://esteamstv.devs.surf" \\
  --output screenshot.png</pre>

    <h2 class="doc-h2">Translator</h2>
    <p class="doc-p"><span class="badge badge-get">GET</span> <code>/api/v1/dev/translate?text=&amp;to=</code></p>
    <p class="doc-p">Use ISO language codes (e.g. <code>en</code>, <code>es</code>, <code>fr</code>, <code>ja</code>). Optional <code>from</code>, defaults to auto-detect. 500 character limit.</p>
    <pre>curl -H "x-api-key: estv_your_key_here" \\
  "https://esteamstv.devs.surf/api/v1/dev/translate?text=Hello&to=es"</pre>
    <pre>{
  "input": "Hello",
  "from": "auto",
  "to": "es",
  "result": "Hola"
    ...
    <h2 class="doc-h2">WhatsApp Number Check</h2>
    <p class="doc-p"><span class="badge badge-get">GET</span> <code>/api/v1/dev/wa-check?number=</code></p>
    <p class="doc-p">Checks whether a phone number is registered on WhatsApp. Digits only, with country code, no <code>+</code> or spaces. This routes through a currently connected bot on the platform to perform the lookup, so it returns a 503 if none are online at the moment.</p>
    <pre>curl -H "x-api-key: estv_your_key_here" \\
  "https://esteamstv.devs.surf/api/v1/dev/wa-check?number=2348012345678"</pre>
    <pre>{
  "exists": true,
...
(function(){
  ...
  var TRYIT_ENDPOINTS = {
    ...
    password: { title: 'Try it - Password Generator', method: 'GET', path: '/api/v1/dev/password', param: 'length', label: 'Length (optional, default 16)', placeholder: '20', optional: true },
    hash: { title: 'Try it - Hash and Base64', method: 'POST', path: '/api/v1/dev/hash', param: 'text', label: 'Text to hash (SHA256)', placeholder: 'hello world', body: true },
    screenshot: { title: 'Try it - Website Screenshot', method: 'GET', path: '/api/v1/dev/screenshot', param: 'url', label: 'Website URL', placeholder: 'https://esteamstv.devs.surf', isImage: true },
    translate: { title: 'Try it - Translator', method: 'GET', path: '/api/v1/dev/translate', label: 'Text - Target language code (e.g. Hello - es)', placeholder: 'Hello - es', parts: ['text', 'to'], splitOn: ' - ' },
    wacheck: { title: 'Try it - WhatsApp Number Check', method: 'GET', path: '/api/v1/dev/wa-check', param: 'number', label: 'Phone number (digits only, with country code)', placeholder: '2348012345678' },
