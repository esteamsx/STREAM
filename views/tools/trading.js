...
export function renderTradingGuestGate(cfg) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
.gate-card{
  ...
  padding:36px 28px;filter:blur(0);
}
.gate-icon{
...
<div class="gate-card">
  <div class="gate-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 018 0v4"/></svg></div>
  <h1>Sign in to trade</h1>
  <p>Trading uses your own account and API keys, so you will need to sign in first. Sign in now and you will land right back here.</p>
