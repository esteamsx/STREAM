...
const CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      { href: "/tools/block-explorer", name: "Base Block Explorer", desc: "Check any Base Mainnet address: balance, contract status, token info, activity.", icon: `<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/>` },
...
export function renderToolsIndexGuestGate(cfg) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="gate-card">
  <div class="gate-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="4" y="4" width="7" height="7" rx="1.5"/><rect x="13" y="4" width="7" height="7" rx="1.5"/><rect x="4" y="13" width="7" height="7" rx="1.5"/><rect x="13" y="13" width="7" height="7" rx="1.5"/></svg></div>
  <h1>Sign in to view Tools</h1>
  <p>Sign in to see the full tools list. Sign in now and you will land right back here.</p>
